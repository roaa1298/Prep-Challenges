...
const recursionPattern = (int1, int2) => {
    let arr=[];
    for(var i=int1 ; i>=-4 ; i-=int2)
    {
        arr.push(i);
    }
    for(var i=-4+int2 ; i<=int1 ; i+=int2)
    {
        arr.push(i);
    }
    return arr;
...
const filterLinks = (str) => {
    let first=str.indexOf("www");
    if(str.indexOf(".com")!=-1)
    {
        return str.slice(first, str.indexOf(".com")+4)
    }
    if(str.indexOf(".org")!=-1)
    {
        return str.slice(first, str.indexOf(".org")+4)
    }
    if(str.indexOf(".net")!=-1)
    {
        return str.slice(first, str.indexOf(".net")+4)
    }
}
// -------------------------------------------------------------------------------------------------------
